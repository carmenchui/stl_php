...
$exclude_items = array('indextest.php','index_old.php','index.php','sitemap.php','resources','Miscellaneous','anywhereinfiles.php','TestFolder');
...
if (is_array($objects)){// && fm_is_exclude_items($current_path)) {
    foreach ($objects as $file) {
        ...
        if ($file == 'index.php' || $file == 'indextest.php'|| $file == 'sitemap.php' || $file == 'index_old.php'|| $file == 'anywhereinfiles.php'){
        	break;
        }
        $new_path = $path . '/' . $file;
...
function latest($searchDir, array $files = array()) {
    ...
    while($item = readdir($search)) {
        if ($item == '.' || $item == '..' || $item == "index.php" || $item == "index_latest.php") { continue; }
...
<p class="center">Full Listing of Files: <a href="sitemap.php">Sitemap</a></p>
