...
//         ),
		 array(
            'driver' => 'LocalFileSystem',
            'path'   => '../Books',
            'URL'    => dirname($_SERVER['PHP_SELF']) . '/../Books',
            'alias'  => 'Books',
        ),
        array(
            'driver' => 'LocalFileSystem',
            'path'   => '../Conference & Workshop Proceedings',
            'URL'    => dirname($_SERVER['PHP_SELF']) . '/../Conference & Workshop Proceedings',
            'alias'  => 'Conference & Workshop Proceedings',
        ),
        array(
            'driver' => 'LocalFileSystem',
            'path'   => '../IEEE Standards',
            'URL'    => dirname($_SERVER['PHP_SELF']) . '/../IEEE Standards',
            'alias'  => 'IEEE Standards',
        ),
        array(
            'driver' => 'LocalFileSystem',
            'path'   => '../ISO Standards',
            'URL'    => dirname($_SERVER['PHP_SELF']) . '/../ISO Standards',
            'alias'  => 'ISO Standards',
        ),
        array(
            'driver' => 'LocalFileSystem',
            'path'   => '../Journals',
            'URL'    => dirname($_SERVER['PHP_SELF']) . '/../Journals',
            'alias'  => 'Journals',
        ),
        array(
            'driver' => 'LocalFileSystem',
            'path'   => '../Papers By Topic',
            'URL'    => dirname($_SERVER['PHP_SELF']) . '/../Papers By Topic',
            'alias'  => 'Papers By Topic',
        ),
        array(
            'driver' => 'LocalFileSystem',
            'path'   => '../Tools',
            'URL'    => dirname($_SERVER['PHP_SELF']) . '/../Tools',
            'alias'  => 'Tools',
        ),
        array(
            'driver' => 'LocalFileSystem',
        ...
        array(
            'driver' => 'LocalFileSystem',
            'path'   => '../Webinars',
            'URL'    => dirname($_SERVER['PHP_SELF']) . '/../Webinars',
            'alias'  => 'Webinars',
        ),
